...
import com.will.shop.dao.CategoryMapper;
...
//		}
    ...
    public List<Category> categoryListToTree(List<Category> categories) {
    ...
    public void transformCategoryTree(List<Category> categories, Map<Long, List<Category>> categoryMap) {
