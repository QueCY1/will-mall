...
public class DefaultExceptionHandlerConfig {
    ...
    @ExceptionHandler(WillShopBindException.class)
    public ResponseEntity<ServerResponseEntity<?>> unauthorizedExceptionHandler(WillShopBindException e) {
        ...
        return ResponseEntity.status(HttpStatus.OK).body(Objects.requireNonNullElseGet(serverResponseEntity, () ->
                ServerResponseEntity.fail(e.getCode(), e.getMessage())));
    }
