...
import com.will.shop.bean.app.param.ProdCommParam;
...
public class ProdCommController {
    ...
    public ServerResponseEntity<IPage<ProdCommDto>> getProdCommPage(PageParam<ProdCommDto> page) {
    ...
    public ServerResponseEntity<IPage<ProdCommDto>> getProdCommPageByProdId(PageParam<ProdCommDto> page, Long prodId, Integer evaluate) {
